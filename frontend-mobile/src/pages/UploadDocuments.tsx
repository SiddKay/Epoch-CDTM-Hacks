...
<div className="flex flex-col h-[calc(100vh-140px)] max-h-[calc(100vh-140px)] overflow-hidden">
        <div className="flex-1 relative min-h-0">
          ...
          <iframe src="/lovable-uploads/7902c203-fa49-4fe0-a9f3-3fbed5495484.png" title="Friendly cartoon helper" className="w-full h-full border-none bg-secondary/30 object-contain" sandbox="allow-same-origin" loading="lazy" />
          
          {/* Success overlay - shown when all uploads are complete */}
          {uploadCompleted && <div className="absolute inset-0 bg-background/80 flex items-center justify-center flex-col">
